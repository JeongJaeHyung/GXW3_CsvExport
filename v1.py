...
DELAY = 0.6       # 동작 사이의 대기 시간
BASE_DIR = os.path.dirname(os.path.abspath(__file__))


# 아이콘 경로 설정
ICONS = {
    "program": os.path.join(BASE_DIR, 'icons', 'program.png'),
    "scan":    os.path.join(BASE_DIR, 'icons', 'scan.png'),
    "unit":    os.path.join(BASE_DIR, 'icons', 'unit.png'),
    "folder":  os.path.join(BASE_DIR, 'icons', 'folder.png'),
    "target":  os.path.join(BASE_DIR, 'icons', 'target.png'),
    "target2": os.path.join(BASE_DIR, 'icons', 'target2.png') # 선택된 노란색 상태
}
